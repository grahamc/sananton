...
class CategoryTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('SLUG', 'Slug', 'VARCHAR', true, 20, null);
		// validators
	} // initialize()
	...
	{
    $this->addRelation('PersonCategory', 'PersonCategory', RelationMap::ONE_TO_MANY, array('id' => 'category_id', ), 'RESTRICT', 'CASCADE');
	} // buildRelations()
