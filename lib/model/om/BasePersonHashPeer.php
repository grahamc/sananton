...
abstract class BasePersonHashPeer {
	...
	const HASH = 'person_hash.HASH';

	/** the column name for the USED field */
	const USED = 'person_hash.USED';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('PersonId', 'Hash', 'Used', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('personId', 'hash', 'used', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::PERSON_ID, self::HASH, self::USED, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('person_id', 'hash', 'used', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('PersonId' => 0, 'Hash' => 1, 'Used' => 2, 'CreatedAt' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('personId' => 0, 'hash' => 1, 'used' => 2, 'createdAt' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::PERSON_ID => 0, self::HASH => 1, self::USED => 2, self::CREATED_AT => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('person_id' => 0, 'hash' => 1, 'used' => 2, 'created_at' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PersonHashPeer::HASH);
		$criteria->addSelectColumn(PersonHashPeer::USED);
	...
	public static function addInstanceToPool(PersonHash $obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = serialize(array((string) $obj->getPersonId(), (string) $obj->getHash()));
			} // if key === null
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof PersonHash) {
				$key = serialize(array((string) $value->getPersonId(), (string) $value->getHash()));
    ...
    foreach (sfMixer::getCallables('BasePersonHashPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePersonHashPeer', $values, $con))
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(PersonHashPeer::HASH);
			$selectCriteria->add(PersonHashPeer::HASH, $criteria->remove(PersonHashPeer::HASH), $comparison);
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			foreach ($values as $value) {
				...
				$criterion->addAnd($criteria->getNewCriterion(PersonHashPeer::HASH, $value[1]));
	 ...
	 * @return     PersonHash
	 */
	public static function retrieveByPK($person_id, $hash, PropelPDO $con = null) {
		$key = serialize(array((string) $person_id, (string) $hash));
 		if (null !== ($obj = PersonHashPeer::getInstanceFromPool($key))) {
 			return $obj;
		}
		...
		$criteria->add(PersonHashPeer::HASH, $hash);
