...
abstract class BasePersonHashPeer {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(PersonHashPeer::HASH, (array) $values, Criteria::IN);
			// invalidate the cache for this object(s)
			foreach ((array) $values as $singleval) {
				PersonHashPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = PersonHashPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
		...
		$criteria->add(PersonHashPeer::HASH, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(PersonHashPeer::DATABASE_NAME);
			$criteria->add(PersonHashPeer::HASH, $pks, Criteria::IN);
			$objs = PersonHashPeer::doSelect($criteria, $con);
		}
		return $objs;
	}
