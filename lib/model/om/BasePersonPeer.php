...
abstract class BasePersonPeer {
	...
	/** the column name for the VALIDATED_AT field */
	const VALIDATED_AT = 'person.VALIDATED_AT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Website', 'Email', 'Image', 'ValidatedAt', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'website', 'email', 'image', 'validatedAt', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::WEBSITE, self::EMAIL, self::IMAGE, self::VALIDATED_AT, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'website', 'email', 'image', 'validated_at', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Website' => 2, 'Email' => 3, 'Image' => 4, 'ValidatedAt' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'website' => 2, 'email' => 3, 'image' => 4, 'validatedAt' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::WEBSITE => 2, self::EMAIL => 3, self::IMAGE => 4, self::VALIDATED_AT => 5, self::CREATED_AT => 6, self::UPDATED_AT => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'website' => 2, 'email' => 3, 'image' => 4, 'validated_at' => 5, 'created_at' => 6, 'updated_at' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PersonPeer::VALIDATED_AT);
		$criteria->addSelectColumn(PersonPeer::CREATED_AT);
		$criteria->addSelectColumn(PersonPeer::UPDATED_AT);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BasePersonPeer', $criteria, $con);
		}
	...
	{
		// invalidate objects in PersonCategoryPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
		PersonCategoryPeer::clearInstancePool();

		// invalidate objects in PersonHashPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePersonPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePersonPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePersonPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasePersonPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePersonPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePersonPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePersonPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasePersonPeer', $values, $con, $ret);
    }
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related PersonCategory objects
			$criteria = new Criteria(PersonCategoryPeer::DATABASE_NAME);
			
			$criteria->add(PersonCategoryPeer::PERSON_ID, $obj->getId());
			$affectedRows += PersonCategoryPeer::doDelete($criteria, $con);

			// delete related PersonHash objects
			$criteria = new Criteria(PersonHashPeer::DATABASE_NAME);
			
			$criteria->add(PersonHashPeer::PERSON_ID, $obj->getId());
			$affectedRows += PersonHashPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
	...
	{
	  return array(array('website'), array('email'));
	}
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BasePersonPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
