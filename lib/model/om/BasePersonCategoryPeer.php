...
abstract class BasePersonCategoryPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('PersonId', 'CategoryId', 'Id', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('personId', 'categoryId', 'id', ),
		BasePeer::TYPE_COLNAME => array (self::PERSON_ID, self::CATEGORY_ID, self::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('person_id', 'category_id', 'id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('PersonId' => 0, 'CategoryId' => 1, 'Id' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('personId' => 0, 'categoryId' => 1, 'id' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::PERSON_ID => 0, self::CATEGORY_ID => 1, self::ID => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('person_id' => 0, 'category_id' => 1, 'id' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PersonCategoryPeer::ID);
	}
    ...
    foreach (sfMixer::getCallables('BasePersonCategoryPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePersonCategoryPeer', $values, $con))
      {
		...
		if ($criteria->containsKey(PersonCategoryPeer::ID) && $criteria->keyContainsValue(PersonCategoryPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.PersonCategoryPeer::ID.')');
		}
    ...
    foreach (sfMixer::getCallables('BasePersonCategoryPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePersonCategoryPeer', $values, $con))
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(PersonCategoryPeer::ID);
			$selectCriteria->add(PersonCategoryPeer::ID, $criteria->remove(PersonCategoryPeer::ID), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(PersonCategoryPeer::ID, (array) $values, Criteria::IN);
			// invalidate the cache for this object(s)
			foreach ((array) $values as $singleval) {
				PersonCategoryPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = PersonCategoryPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
		...
		$criteria->add(PersonCategoryPeer::ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(PersonCategoryPeer::DATABASE_NAME);
			$criteria->add(PersonCategoryPeer::ID, $pks, Criteria::IN);
			$objs = PersonCategoryPeer::doSelect($criteria, $con);
		}
		return $objs;
	}
